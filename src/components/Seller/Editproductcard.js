        ...
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="grid grid-cols-2 gap-7">
            <button
              ...
              className=" items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-slate-500 rounded-lg focus:ring-4 focus:ring-gray-200  hover:bg-gray-800"
            >
              Edit product
            </button>
            <button
